(() => {
  ...
  loadPayload()
    ...
    .then(async payload => {
      ...
      await loadScript('./assets/js/amorist-app.js?v=game-dates-v13-20260728');
      await loadScript('./assets/js/oshi-hub.js?v=game-dates-v13-20260728');
      await loadScript('./assets/js/public-mode.js?v=game-dates-v13-20260728');
    });
})();
