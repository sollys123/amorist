(() => {
  ...
  loadPayload()
    ...
    .then(async payload => {
      ...
      await loadScript('./assets/js/amorist-app.js?v=calendar-v1-20260729');
      await loadScript('./assets/js/oshi-hub.js?v=calendar-v1-20260729');
      await loadScript('./assets/js/public-mode.js?v=calendar-v1-20260729');
    });
})();
