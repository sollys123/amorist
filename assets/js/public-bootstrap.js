(() => {
  ...
  loadPayload()
    ...
    .then(async payload => {
      ...
      await loadScript('./assets/js/amorist-app.js?v=platform-v1-20260731');
      await loadScript('./assets/js/oshi-hub.js?v=platform-v1-20260731');
      await loadScript('./assets/js/public-mode.js?v=platform-v1-20260731');
    });
})();
